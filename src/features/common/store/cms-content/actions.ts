...
const setCmsContent = (cmsData?: any) => {
	...
	const header = cmsSiteContent.getContentByPaths(cmsData, defaultCMSData)({
		headerLogoURL: 'default-header.logo',
		headerItemsDFA: 'default-header.menu.items',
	});

	const home = cmsSiteContent.getContentByPaths(cmsData, defaultCMSData)({
	...
	const login = cmsSiteContent.getContentByPaths(cmsData, defaultCMSData)({
		loginImageURL: 'login.logo',
	});

	const footer = cmsSiteContent.getContentByPaths(cmsData, defaultCMSData)({
